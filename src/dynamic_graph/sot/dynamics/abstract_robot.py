...
from dynamic_graph.sot.core import RobotSimu, FeatureGeneric, Task
...
class AbstractRobot (object):
    ...
    representation of a generic robot, mainly:
    ...
    For instance if creating an operational point for the end-effector,
    the associated signals will be called "end-effector" and
    "Jend-effector" for respectively the position and the jacobian.
    """
    ...
    tasks = dict()
    """
    Tasks associated to each operational point. Keys are
    corresponding to operational points.
    """
